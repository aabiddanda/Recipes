...
\recipecolumn{
	...
	\begin{enumerate}
		...
		\item Once crust begins to form on chicken, lower heat to low and place all other ingredients in pot. Make sure to deglaze pan with red wine first.  Raise temperature again till liquid starts to boil around chicken and then lower to low in order to really let liquid braise the meat.
		\item Garnish with parsley and simple roasted vegetables.
	\end{enumerate}
}
...
\recipe{Chard and Cannellini Beans}
\recipecolumn{
	\begin{itemize}
		\item Swiss Chard
		\item Minced Garlic
	...
	\begin{enumerate}
		\item Roughly chop up chard, and saute on low-medium heat with olive oil and later add sherry/madiera. Add in light minced garlic and pepper and butter as well. 
		\item Remove chard from pan, and then place in beans. Add oil as needed and minced garlic and lemon juice. Add chard back in after beans are heated through.
		\item Best served with wild rice and skillet chicken.  
	\end{enumerate}
}
