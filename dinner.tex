...
\recipe{Orichette with Caramelized Lemons and Peas}
\recipecolumn{
	\begin{itemize}
		\item Orichette
		\item Lemons (sliced)
	...
	\begin{enumerate}
		\item Bring water to a boil (add salt), cook orichette until \textit{al dente}
		\item While orichette is cooking, dust lemon slices with sugar and salt
		\item Place pan on very high heat and put in lemons to caramelize (~1 min on each side)
		\item Add orichiette and peas (with little bit of pasta water) and turn heat to low
		\item Remove from heat and add butter stirring to make pan sauce. After 1 minute off heat add parmesan cheese and stir through
		\item Garnish with mint leaves, lemon zest, and additional parmesan if needed.  
	\end{enumerate}
}
