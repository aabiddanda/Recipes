...
\recipecolumn{
	...
	\begin{enumerate}	
		...
		\item Optional : add $\frac{1}{2}$ cup red wine, $\frac{1}{2}$ cup chicken stock, 1 tbsp honey, and simmer sauce in pan and reduce to make sauce. 
		\item Place onions on top of lamb slices and serve alongside salad
	\end{enumerate}
}
...
\recipe{Chicken Breast with Brussel Sprouts and Walnuts}
\recipecolumn{
	\begin{itemize}
		\item 4 Chicken Breast Halves (pounded flat)
		\item 1 cup Brussel Sprouts (chopped finely)
		\item 1/4 cup chopped walnuts 
		\item Olive oil \footnote{The garlic butter recipe from above will work quite well too}
		\item Garlic (finely diced)
		\item Pecorino cheese \footnote{Parmesan can be used as well}
		\item Salt
		\item Pepper
	\end{itemize}
}{
	\begin{enumerate}
		\item With a mixer, blend brussel sprouts, walnuts, garlic, and olive oil into a rough paste. If the pecorino cheese is powdered feel free to add this to the mix as well. 
		\item Heat up pan with olive oil. Roll up chicken breasts with brussel sprout mixture in the middle. Season rolled chicken breasts with salt and pepper. At this time preheat the oven to 350 degrees.
		\item Place chicken breasts seam-side-down into the pan and let them fry for approximately 5 minutes.
		\item Transfer to oven and allow for chicken to cook thoroughly. Serve alongside rice or pasta. 
	\end{enumerate}
}
...
\recipecolumn{
	\begin{itemize}
		\item 4 Chicken Thighs
		\item Marjoram (6 leaves)
		\item Thyme (6 leaves)
	...
	\begin{enumerate}
		\item Sprinkle salt and pepper on chicken thighs (especially on the skin). Heat olive oil in pan to high heat. 
		\item Place thighs, skin side down, in the pan. Cook on high heat for 3 minutes and flip. Lower to medium heat.
		\item Crush garlic with the flat side of a knife, and place garlic and marjorum and thyme in the pan. 
		\item Place butter in pan and allow to melt. Raise heat slightly and serve over a bed of wild rice. 
	\end{enumerate}
}
...
\newpage
\section{Seafood}
\recipe{Kerala-Style Pan Seared Shrimp}
\recipecolumn{
	\begin{itemize}
		\item $\frac{1}{2}$ lb uncooked shrimp (deveined)
		\item Olive oil
		\item Salt
		\item Pepper
	...
	\begin{enumerate}
		\item In a small bowl, mix ginger-garlic paste, turmeric, garam masala, lime juice, and raisins. The paste should be relatively thick.
		...
		\item Serve on a bed of basmati rice or alongside roasted vegetables and a dry white wine
	\end{enumerate}
}
...
\recipecolumn{
	\begin{itemize}
		...
		\item 2 Onions (diced)\footnote{Add an optional shallot for an extra flavor}
		\item 3 cloves of Garlic (finely chopped)
		\item $\frac{2}{3}$ Tbsp Basil (finely chopped)
		\item $\frac{1}{4}$ stick butter
		\item 2 Tbsp salt
		\item 2 Tbsp pepper
...
\recipecolumn{
	\begin{itemize}
		\item 1 lb brussel sprouts (de-stemmed and sliced in half) \footnote{You can really do this with any vegetables. Peppers and onions work really well here too.}
		\item Olive oil
		\item Minced Garlic
		\item Orange Balsamic Glaze (see Recipe above)
		\item Salt
		\item Pepper
	\end{itemize}
}{
	\begin{enumerate}
		\item Toss brussel sprouts with olive oil and minced garlic in a small bowl. 
		\item Transfer brussel sprouts to baking sheet with oil spread on it and place baking sheet in oven at 400 degrees for 10 minutes. 
		\item Coat brussel sprouts with orange balsamic glaze and then place back in oven at 400 degrees to allow for glaze to caramelize. 
		\item Remove and serve hot.    
	\end{enumerate}
}

\recipe{Swiss Chard with Madiera}
\recipecolumn{
	\begin{itemize}
		\item $\frac{1}{8}$-cup sherry
		\item $\frac{1}{8}$-cup madiera
		\item 1 lb Swiss Chard
		\item 1 shallot (finely diced)
		\item 3 gloves garlic (finely diced)
		\item 3 Tbsp butter
		\item Pepper
		\item Sliced almonds (optional)
		\item Shaved parmesan cheese (optional)
	\end{itemize}
}{
	\begin{enumerate}
		\item Heat large skillet to medium heat. Melt butter and add garlic and shallots. 
		\item Turn heat to high and add chard stem-first. Ideally you will have chopped off a good portion of the stems prior to adding them to the pan.
		\item After a minute, and once the chard has reduced add both the madiera and sherry.
		\item Allow the sherry and madiera to reduce substantially so that all of the alcohol is evaporated out. 
		\item Lower to low heat before serving and top with pepper, almonds, and parmesan cheese.\footnote{This recipe was borrowed from a friend of mine after an amazing potluck, and most of the credit goes to him. You can find him here : \href{http://www.johnparkbiology.com/}{http://www.johnparkbiology.com/}}   
	\end{enumerate}
}
