...
\recipecolumn{
	\begin{itemize}
		\item $\frac{1}{4}$ cup Honey
		\item 3 sprigs fresh Thyme
		\item 3 springs fresh Rosemary
		\item 3 sprigs fresh lavender
		\item 3 leaves fresh basil
	\end{itemize}
}{
	\begin{enumerate}
		\item Place all honey into a jar. Lightly char herbs over gas flame and place them into jar as they are smoking. 
		\item Place jar in fridge for a night or longer and remove herbs before serving. \footnote{This works great for making drinks, particularly with clear liquors}
	\end{enumerate}	
}

\recipe{Roasted Red Pepper and Garlic Spread}
\recipecolumn{
	\begin{itemize}
		\item 3 Red Peppers
		\item 6 cloves Garlic (unpeeled)
		\item $\frac{1}{4}$ cup olive oil
		\item 2 Tbsp Dry Thyme
		\item Salt \& Pepper (to taste)
	\end{itemize}
}{
	\begin{enumerate}
		\item Slice red peppers and place onto aluminium foil baking sheet. Preheat oven to 420 degrees. Drizzle with olive oil (generously) and place in oven for 15 minutes
		\item After 10 minutes, place garlic cloves on baking sheet as well to roast.
		\item Blitz up all roasted ingredients + thyme in a food processor. Add salt and pepper to taste. Serve with pita chips or on top of french bread as bruchetta.  
	\end{enumerate}	
}
