...
\recipecolumn{
	...
	\begin{itemize}
		...
		\item After taking out roasted potatoes, let cool for 5 minutes and then toss in bowl with dressing. Garnish with extra parsley if needed.
	\end{itemize}
}
...
\recipe{Soy-Ginger Lettuce Wraps}
\recipecolumn{
	\begin{itemize}
		\item $\frac{1}{2}$ lb ground turkey
		\item $\frac{1}{2}$ tbsp garlic powder
		\item $\frac{1}{2}$ tbsp ginger powder\footnote{If fresh ginger and garlic available, used that instead}
		\item 5 fresh basil leaves (chopped)
		\item $\frac{1}{2}$ tbsp pepper
		\item $\frac{1}{8}$ cup soy sauce
		\item 3 tbsp honey (or brown sugar)
		\item 1 packet raw Ramen
		\item 1 head of Lettuce
	\end{itemize}
}{
	\begin{enumerate}
		\item Mix together garlic powder, basile, ginger powder, pepper, honey, and soy sauce in small cup. Pour over ground turkey and allow to marinate for 30 minutes
		\item In a skillet heat up oil to medium high and then add turkey with marinade and cook for 10 minutes until golden
		\item Add raw ramen to pan and then heat on high to reduce all remaining liquid
		\item Serve inside lettuce leaves and with hoisin or other sauces
	\end{enumerate}
}
