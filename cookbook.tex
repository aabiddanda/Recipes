...
\recipecolumn{
	\begin{itemize}
		\item $\frac{1}{2}$ cup chicken stock
		\item $\frac{1}{4}$ cup finely diced\footnote{Mashing shallots in a food processor with little chicken broth works great} shallots
		\item $\frac{1}{4}$ cup dry White Wine
		\item $3$ tablespoons butter
		\item $\frac{1}{4}$ cup chopped chives
		\item $1$ tablespoon black pepper
	\end{itemize}
}{
	\begin{enumerate}
		...
		\item After reduced to a quarter of previous volume, lessen heat and stir in butter and chives \footnote{Recipe here is an adaptation from one found \href{http://www.myrecipes.com/recipe/white-wine-sauce}{here}}
	\end{enumerate}
}
...
\recipe{Braised Lamb with Grilled Onions}
\recipecolumn{
	\begin{enumerate}
	...
	\begin{enumerate}	
		\item Unpack the lamb and rub with salt and pepper. Sprinkle with lemon juice and let sit for 5 minutes
		...
		\item Place onions on top of lab slices and serve alongside salad\footnote{This dish goes really well with an Argentinian Malbec as well as any Merlot}
	\end{enumerate}
}
