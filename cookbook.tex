...
% TODO : add tips to the tips section
...
\recipe{Moroccan-Style Lamb Burgers}
\recipecolumn{
	\begin{itemize}	
	...
	\begin{enumerate}
		...
		\item In pan heat olive oil and sautee onion and garlic\footnote{Ginger if fresh}.\footnote{If a food processor is available, use that to create finer paste of the onions and garlic}
...
\newpage
\recipe{Roasted Vegetables with Garlic Butter}
\recipecolumn{
	\begin{itemize}
